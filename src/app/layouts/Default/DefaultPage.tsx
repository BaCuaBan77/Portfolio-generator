...
export default function DefaultPage({ portfolio, projects }: DefaultPageProps) {
  const isDarkTheme = (process.env.THEME || "").toLowerCase() === "dark";
  ...
  return (
    <main className={`${styles.defaultPage} ${isDarkTheme ? styles.dark : ""}`}>
      {/* Header */}
                    ...
                    <div className={styles.skillTags}>
                      {group.items.map((item, idx) => (
                        <motion.span
                          ...
                          animate={
                            capabilitiesInView ? { opacity: 1, scale: 1 } : {}
                          }
                          transition={{
                            duration: 0.5,
                            delay: 0.5 + gIdx * 0.05 + idx * 0.03,
                            ease: [0.25, 0.1, 0.25, 1],
                          }}
            ...
            >
              ...
              <div className={styles.capabilityList}>
                {portfolio.domains.map((domain, index) => (
                  ...
                  >
                    <div
                      className={styles.capabilityBullet}
        ...
        <div className={styles.container}>
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--color-text-light)" }}
            >
              A collection of my work across professional and personal
              explorations
            </p>
          </motion.div>
          ...
          >
            {(["all", "professional", "personal"] as const).map(
              (filterType) => (
                <button
                  key={filterType}
          ...
          {filter !== "personal" && professionalProjects.length > 0 && (
            ...
            >
              <h3
                className={styles.projectsCategoryTitle}
                style={{ color: "var(--color-text)" }}
              >
                Professional Projects
              </h3>
          ...
          {filteredProjects.length === 0 && (
            ...
            >
              <p
                className={styles.noProjectsText}
                style={{ color: "var(--color-text-light)" }}
              >
          ...
          >
            <div className={styles.contactGrid}>
              ...
              >
                ...
                <h3
                  className={styles.contactCardTitle}
                  style={{ color: "var(--color-text)" }}
                >
                  Email
                </h3>
